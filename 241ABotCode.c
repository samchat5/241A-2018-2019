...
#pragma config(Motor,  port3,           L3,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           R1,            tmotorVex393_MC29, openLoop, encoderPort, None)
#pragma config(Motor,  port5,           R2,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           R3,            tmotorVex393_MC29, openLoop)
